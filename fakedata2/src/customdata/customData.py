...
class CustomValues(BaseProvider):
    ...
    def custom_list(self, word_list, sentence_length):
        data_dictionary = {
                              ...
                              "connection_type_names": ["ATM","Dialer","FastEthernet","GigabitEthernet",
    ...
    def equipment_list(self, sentence_length=0, pos=-1):
        fake_equipment_list = [['1', 'Baltic 125R', '6', '100', '1', '4'],
                               ['2', 'Baltic 800', '88', '150', '1', '4'],
                               ['3', 'Baltic 8002', '168', '150', '1', '4'],
                               ['4', 'Baltic 8004', '168', '150', '1', 'NULL'],
                               ['5', 'Baltic P-660HN', '99', '150', '1', '7'],
                               ['6', 'Baltic P-660FK', '99', '150', '1', '7'],
                               ['7', 'Baltic P-660FK2', '99', '150', '1', 'NULL'],
                               ['8', 'Iris 8133K', '40', '0', '2', '14'],
                               ['9', 'Iris 8133U', '45', '0', '2', '14'],
                               ['10', 'Iris DSL-B13', '20', '0', '2', '13'],
                               ['11', 'Netgo BR-6214', '788', '350', '3', '12'],
                               ['12', 'Netgo BR-6214K', '788', '350', '3', 'NULL'],
                               ['13', 'Netgo DGV558-100', '598', '350', '3', '14'],
                               ['14', 'Netgo DSL-260R', '609', '350', '3', 'NULL'],
                               ['15', 'Netgo DSL-580', '609', '350', '3', '16'],
                               ['16', 'Netgo DSL-590', '609', '350', '3', 'NULL']]
